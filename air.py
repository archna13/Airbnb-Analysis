...
icon = Image.open("airbnbimage.jpg")
st.set_page_config(page_title= "Airbnb Data Visualization | By ARCHANA",
                   page_icon= icon,
                   layout= "wide",
...
client = pymongo.MongoClient("mongodb+srv://archanashrikanth8:mysweety1992@cluster0.9kjhpda.mongodb.net/?retryWrites=true&w=majority")
...
if selected == "Home":
    ...
    col2.markdown (icon = Image.open("airbnbimage.jpg")) 
    col2.markdown("#   ")
